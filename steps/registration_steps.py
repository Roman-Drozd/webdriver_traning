...
class CustomerSteps:
    ...
    def __init__(self, app):
        self.app = app
        self.registration_page = RegistrationPage(self.app.driver)
        self.admin_panel_login_page = AdminPanelLoginPage(self.app.driver)
        self.customer_list_page = CustomerListPage(self.app.driver)
